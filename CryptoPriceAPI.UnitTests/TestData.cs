	...
	public static class TestData
	{
		...
		public static System.Collections.Generic.IEnumerable<CryptoPriceAPI.Data.Entities.Price> GetRandomPrices(System.Int32 number = System.Int32.MaxValue)
		{
			System.Collections.Generic.List<CryptoPriceAPI.Data.Entities.Price> list = new()
			{
				...
				new CryptoPriceAPI.Data.Entities.Price { SourceId = Guid.NewGuid(), DateAndHour = new (new (2022,  3, 16), 12), FinancialInstrument = CryptoPriceAPI.Data.Entities.FinancialInstrument.BTCUSD, ClosePrice = 40652.54f },
				new CryptoPriceAPI.Data.Entities.Price { SourceId = Guid.NewGuid(), DateAndHour = new (new (2022,  7,  1), 12), FinancialInstrument = CryptoPriceAPI.Data.Entities.FinancialInstrument.BTCUSD, ClosePrice = 19460.875f },
				new CryptoPriceAPI.Data.Entities.Price { SourceId = Guid.NewGuid(), DateAndHour = new (new (2022, 11, 16), 12), FinancialInstrument = CryptoPriceAPI.Data.Entities.FinancialInstrument.BTCUSD, ClosePrice = 16484f },
			};
